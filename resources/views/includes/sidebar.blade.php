  ...
  <div class="sidebar-inner">
    ...
    <div class="sidebar-logo">
      <div class="peers ai-c fxw-nw">
        <div class="peer peer-greed">
          <a class="sidebar-link td-n" href="{{ route('adminator.index') }}">
            <div class="peers ai-c fxw-nw">
              <div class="peer">
                <div class="logo">
    ...
    <ul class="sidebar-menu scrollable pos-r">
      <li class="nav-item mT-30">
        <a class="sidebar-link" href="{{ route('adminator.index') }}">
      ...
      <li class="nav-item">
        <a class="sidebar-link" href="{{ route('crud-examples.index') }}">
          <span class="icon-holder">
            <i class="c-brown-500 ti-pencil"></i>
          </span>
          <span class="title">Crud Example</span>
        </a>
      </li>
      <li class="nav-item">
